          ...
          <AnimateIn variant="fadeUp" className="max-w-2xl mx-auto px-6 sm:px-8">
            <div className="text-center mb-10">
              ...
              <p className="text-slate-400">
                Cuéntanos el modelo de tu equipo y lo que necesitas. Te respondemos en menos de 24 horas.
              </p>
            </div>
                ...
                extraFields={[
                  {
                    ...
                    placeholder: 'Ej: Ender 3, Prusa i3, Bambu Lab X1…',
                    required: true,
                  },
                  {
                    name: 'componentType',
                    label: '¿Qué componente o repuesto necesitas?',
                    placeholder: 'Ej: boquilla 0.4 mm, extrusor directo, correa GT2…',
                  },
                ]}
              />
            </div>
